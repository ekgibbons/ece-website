...
\begin{Form}
  ...
  \path (current page.north east) ++ (-7cm,-2cm) node {\includegraphics[width=10cm,alt="ece logo"]{ece_horiz.pdf}};
  ...
  $^2$If you have taken CHEM 1230 instead of CHEM 1210, please enter the letter grad of that course.\\
  $^3$If you have taken MATH 2250 instead of ENGR 2240, please enter the letter grade of that course.\\
  $^4$If you have taken MATH 2270 and MATH 2280 instead of ENGR 2240, enter the average letter grade of the two courses.  If the average is between grades, round up.  E.g., if you get an A in MATH 2270 and a A- in MATH 2280, enter an A for MATH 2250.\\
  $^5$You may substitute ENGR 1000 in lieu for ECE 1000.}
  ...
  \TextField[width=2cm,
    ...
    readonly=true,
    calculate={%
        var chem1230 = this.getField("chem1230pts");
        var chem1235 = this.getField("chem1235pts");
        var math1210 = this.getField("math1210pts");
        var math1220 = this.getField("math1220pts");
        var math2210 = this.getField("math2210pts");
        ...
        var total_points = chem1230.value +
        chem1235.value +
        math1210.value +
        math1220.value +
        math2210.value +
        ...
        ece2260.value +
        ece2700.value;
        event.value = (total_points/49).toFixed(3);
      }
